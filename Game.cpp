...
#include "Brick-Breaker/PostProcessor.h"
...
void Game::ProcessInput(sf::RenderWindow& window, float dt)
{
...
void Game::SpawnPowerUps(GameObject& block)
{
	...
	if (ShouldSpawn(15)) // negative powerups should spawn more often
		this->PowerUps.push_back(
			PowerUp("confuse", glm::vec3(1.0f, 0.3f, 0.3f), 8.0f, block.Position, ResourceManager::GetTexture("powerup_confuse")
			));
	if (ShouldSpawn(15))
		this->PowerUps.push_back(
			PowerUp("chaos", glm::vec3(0.9f, 0.25f, 0.25f), 8.0f, block.Position, ResourceManager::GetTexture("powerup_chaos")
			));
}
